# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-08 02:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(max_length=12, verbose_name='组名')),
            ],
        ),
        migrations.CreateModel(
            name='Permission',
            fields=[
                ...
                ('group', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='rbac.Group')),
            ],
            options={
